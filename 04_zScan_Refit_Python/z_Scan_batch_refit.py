...
# This script is very similar to z_Scan_refit.py, but written to process more datasets at once
...
folders.extend([glob_dir + r'\20240417_Sample1_GUV2'])
file_names_acf_fits.extend(['g_2D_diffOffset_20240417_Sample1_GUV2.csv'])

folders.extend([glob_dir + r'\20240417_Sample1_GUV4'])
file_names_acf_fits.extend(['g_2D_diffOffset_20240417_Sample1_GUV4.csv'])

folders.extend([glob_dir + r'\20240417_Sample1_GUV5'])
file_names_acf_fits.extend(['g_2D_diffOffset_20240417_Sample1_GUV5.csv'])

folders.extend([glob_dir + r'\20240417_Sample2_GUV1'])
file_names_acf_fits.extend(['g_2D_diffOffset_20240417_Sample2_GUV1.csv'])

folders.extend([glob_dir + r'\20240417_Sample2_GUV2'])
file_names_acf_fits.extend(['g_2D_diffOffset_20240417_Sample2_GUV2.csv'])
...
for i_z_scan, output_folder in enumerate(folders):
    
    file_path_acf_fits = os.path.join(output_folder,
                                      file_names_acf_fits[i_z_scan])
    
    file_path_position_list = os.path.join(output_folder, 
                                           'z_scan_positions.csv')
    ...
    for i_xy in range(n_xy):
        ...
        try:
            ...
            if not os.path.exists(output_name):
                ...
                fit_result_df.to_csv(output_name, 
                                      header = True, 
                                      index = False)
            ...
            save_path = os.path.join(output_folder, str(i_xy) + '_' + one_file_name + 'z_scan_refit.png')
